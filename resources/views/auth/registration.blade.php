  ...
  <div class="header-right-content text-end">
    <div class="others-options d-flex align-items-center justify-content-end">
      ...
      <div class="option-item">
        <a href="{{ route('login') }}" class="default-btn" style="font-size: 15px;">Signup</a>
      </div>
    </div>
  </div>
</div>
...
">At Swamitra Insurance, we are committed to providing innovative and reliable insurance solutions that protect what
            ...
            <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                    ...
                    <ul class="footer-widget-list">
                        <li>
                            <a href="{{ route('frontend.index') }}"><i class="bx bx-chevron-right"></i>Home</a>
                        </li>
                        <li>
                            <a href="{{ route('frontend.index') }}"><i class="bx bx-chevron-right"></i>About Us</a>
                        </li>

                        <li>
                            <a href="{{ route('frontend.index') }}"><i class="bx bx-chevron-right"></i>Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
